...
class TestLinkify(unittest.TestCase):
    def test_render(self):
        match = next(
            LINKIFY_DECORATOR["strategy"].finditer("test https://www.example.com")
        )

        self.assertEqual(
            DOM.render(
                DOM.create_element(
                    LINKIFY_DECORATOR["component"],
...
class TestBR(unittest.TestCase):
    ...
    def test_render_code_block(self):
        self.assertEqual(
            DOM.create_element(
                BR_DECORATOR["component"], {"block": {"type": BLOCK_TYPES.CODE}}, "\n"
            ),
            "\n",
        )
