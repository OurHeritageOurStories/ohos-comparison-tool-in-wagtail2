...
def button(props):
    ...
    return DOM.create_element(
        ...
        DOM.create_element("span", {"class": "icon-text__text"}, text)
        if icon_name
        else text,
    )
...
class TestIcon(unittest.TestCase):
    def test_render(self):
        self.assertEqual(
            DOM.render(DOM.create_element(icon, {"name": "rocket"})),
...
class TestButton(unittest.TestCase):
    def test_render_with_icon(self):
        self.assertEqual(
            DOM.render(
                DOM.create_element(
                    button,
                    {"href": "http://example.com", "icon": "rocket", "text": "Launch",},
                )
            ),
    ...
    def test_render_without_icon(self):
        self.assertEqual(
            DOM.render(
                DOM.create_element(
                    button, {"href": "http://example.com", "text": "Launch",}
                )
            ),
