...
class Apng(Type):
    ...
    def __init__(self):
        super(Apng, self).__init__(mime=Apng.MIME, extension=Apng.EXTENSION)
...
class Gif(Type):
    ...
    def __init__(self):
        super(Gif, self).__init__(
            mime=Gif.MIME, extension=Gif.EXTENSION,
        )
...
class Webp(Type):
    ...
    def __init__(self):
        super(Webp, self).__init__(
            mime=Webp.MIME, extension=Webp.EXTENSION,
        )
...
class Cr2(Type):
    ...
    def __init__(self):
        super(Cr2, self).__init__(
            mime=Cr2.MIME, extension=Cr2.EXTENSION,
        )
...
class Tiff(Type):
    ...
    def __init__(self):
        super(Tiff, self).__init__(
            mime=Tiff.MIME, extension=Tiff.EXTENSION,
        )
...
class Bmp(Type):
    ...
    def __init__(self):
        super(Bmp, self).__init__(
            mime=Bmp.MIME, extension=Bmp.EXTENSION,
        )
...
class Jxr(Type):
    ...
    def __init__(self):
        super(Jxr, self).__init__(
            mime=Jxr.MIME, extension=Jxr.EXTENSION,
        )
...
class Psd(Type):
    ...
    def __init__(self):
        super(Psd, self).__init__(
            mime=Psd.MIME, extension=Psd.EXTENSION,
        )
...
class Ico(Type):
    ...
    def __init__(self):
        super(Ico, self).__init__(
            mime=Ico.MIME, extension=Ico.EXTENSION,
        )
...
class Avif(IsoBmff):
    ...
    def __init__(self):
        super(Avif, self).__init__(mime=Avif.MIME, extension=Avif.EXTENSION)
