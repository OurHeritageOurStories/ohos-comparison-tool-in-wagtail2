...
class ExternalCell(Serialisable):
    ...
    def __init__(
        self, r=None, t=None, vm=None, v=None,
    ):
        self.r = r
        self.t = t
        self.vm = vm
...
class ExternalSheetData(Serialisable):
    ...
    def __init__(
        self, sheetId=None, refreshError=None, row=(),
    ):
...
class ExternalDefinedName(Serialisable):
    ...
    def __init__(
        self, name=None, refersTo=None, sheetId=None,
    ):
        self.name = name
...
class ExternalBook(Serialisable):
    ...
    def __init__(
        self, sheetNames=None, definedNames=(), sheetDataSet=None, id=None,
    ):
...
class ExternalLink(Serialisable):
    ...
    def __init__(
        self, externalBook=None, ddeLink=None, oleLink=None, extLst=None,
    ):
