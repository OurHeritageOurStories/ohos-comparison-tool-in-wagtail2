...
class PatternFillProperties(Serialisable):
    ...
    def __init__(
        self, prst=None, fgClr=None, bgClr=None,
    ):
        self.prst = prst
        self.fgClr = fgClr
        self.bgClr = bgClr
...
class PathShadeProperties(Serialisable):
    ...
    def __init__(
        self, path=None, fillToRect=None,
    ):
        self.path = path
...
class TileInfoProperties(Serialisable):
    ...
    def __init__(
        self, tx=None, ty=None, sx=None, sy=None, flip=None, algn=None,
    ):
        self.tx = tx
        self.ty = ty
        self.sx = sx
