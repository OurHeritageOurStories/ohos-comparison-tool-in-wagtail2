...
class GroupTransform2D(Serialisable):
    ...
    def __init__(
        self, rot=0, flipH=None, flipV=None, off=None, ext=None, chOff=None, chExt=None,
    ):
        self.rot = rot
        self.flipH = flipH
        self.flipV = flipV
...
class SphereCoords(Serialisable):
    ...
    def __init__(
        self, lat=None, lon=None, rev=None,
    ):
        self.lat = lat
        self.lon = lon
        self.rev = rev
...
class Camera(Serialisable):
    ...
    def __init__(
        self, prst=None, fov=None, zoom=None, rot=None,
    ):
        self.prst = prst
        self.fov = fov
        self.zoom = zoom
...
class LightRig(Serialisable):
    ...
    def __init__(
        self, rig=None, dir=None, rot=None,
    ):
        self.rig = rig
        self.dir = dir
        self.rot = rot
...
class Backdrop(Serialisable):
    ...
    def __init__(
        self, anchor=None, norm=None, up=None, extLst=None,
    ):
        self.anchor = anchor
        self.norm = norm
        self.up = up
...
class Scene3D(Serialisable):
    ...
    def __init__(
        self, camera=None, lightRig=None, backdrop=None, extLst=None,
    ):
        self.camera = camera
...
class Path2D(Serialisable):
    ...
    def __init__(
        self, w=None, h=None, fill=None, stroke=None, extrusionOk=None,
    ):
        self.w = w
        self.h = h
        self.fill = fill
...
class CustomGeometry2D(Serialisable):
    ...
    def __init__(
        self, avLst=None, gdLst=None, ahLst=None, cxnLst=None, rect=None, pathLst=None,
    ):
        self.avLst = avLst
        self.gdLst = gdLst
        self.ahLst = ahLst
...
class ShapeStyle(Serialisable):
    ...
    def __init__(
        self, lnRef=None, fillRef=None, effectRef=None, fontRef=None,
    ):
        self.lnRef = lnRef
