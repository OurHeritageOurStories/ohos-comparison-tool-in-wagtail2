...
class NonVisualConnectorProperties(Serialisable):
    ...
    def __init__(
        self, cxnSpLocks=None, stCxn=None, endCxn=None, extLst=None,
    ):
...
class ConnectorNonVisual(Serialisable):
    ...
    def __init__(
        self, cNvPr=None, cNvCxnSpPr=None,
    ):
        self.cNvPr = cNvPr
...
class ConnectorShape(Serialisable):
    ...
    def __init__(
        self, nvCxnSpPr=None, spPr=None, style=None, macro=None, fPublished=None,
    ):
