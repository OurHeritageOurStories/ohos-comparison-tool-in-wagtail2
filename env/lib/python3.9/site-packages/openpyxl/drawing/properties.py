...
class GroupShapeProperties(Serialisable):
    ...
    def __init__(
        self, bwMode=None, xfrm=None, scene3d=None, extLst=None,
    ):
        self.bwMode = bwMode
        self.xfrm = xfrm
...
class NonVisualGroupDrawingShapeProps(Serialisable):
    ...
    def __init__(
        self, grpSpLocks=None, extLst=None,
    ):
...
class NonVisualDrawingShapeProps(Serialisable):
    ...
    def __init__(
        self, spLocks=None, txBox=None, extLst=None,
    ):
...
class NonVisualGroupShape(Serialisable):
    ...
    def __init__(
        self, cNvPr=None, cNvGrpSpPr=None,
    ):
        self.cNvPr = cNvPr
