...
class Font(Serialisable):
    ...
    def __init__(
        self, typeface=None, panose=None, pitchFamily=None, charset=None,
    ):
...
class TextField(Serialisable):
    ...
    def __init__(
        self, id=None, type=None, rPr=None, pPr=None, t=None,
    ):
        self.id = id
        self.type = type
        self.rPr = rPr
...
class Paragraph(Serialisable):
    ...
    def __init__(
        self, pPr=None, endParaRPr=None, r=None, br=None, fld=None,
    ):
        self.pPr = pPr
...
class TextNormalAutofit(Serialisable):
    ...
    def __init__(
        self, fontScale=None, lnSpcReduction=None,
    ):
