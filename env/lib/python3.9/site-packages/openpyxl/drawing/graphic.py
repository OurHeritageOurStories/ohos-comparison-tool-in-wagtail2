...
class NonVisualGraphicFrameProperties(Serialisable):
    ...
    def __init__(
        self, graphicFrameLocks=None, extLst=None,
    ):
...
class NonVisualGraphicFrame(Serialisable):
    ...
    def __init__(
        self, cNvPr=None, cNvGraphicFramePr=None,
    ):
        if cNvPr is None:
...
class GroupShape(Serialisable):
    ...
    def __init__(
        self, nvGrpSpPr=None, grpSpPr=None, pic=None,
    ):
