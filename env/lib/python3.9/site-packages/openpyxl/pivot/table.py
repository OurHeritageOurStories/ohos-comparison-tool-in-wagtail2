...
class ColHierarchiesUsage(Serialisable):
    ...
    def __init__(
        self, count=None, colHierarchyUsage=(),
    ):
...
class RowHierarchiesUsage(Serialisable):
    ...
    def __init__(
        self, count=None, rowHierarchyUsage=(),
    ):
...
class MemberList(Serialisable):
    ...
    def __init__(
        self, count=None, level=None, member=(),
    ):
        self.level = level
        self.member = member
...
class ChartFormat(Serialisable):
    ...
    def __init__(
        self, chart=None, format=None, series=None, pivotArea=None,
    ):
        self.chart = chart
        self.format = format
        self.series = series
...
class ConditionalFormat(Serialisable):
    ...
    def __init__(
        self, scope="selection", type=None, priority=None, pivotAreas=(), extLst=None,
    ):
        self.scope = scope
        self.type = type
...
class Format(Serialisable):
    ...
    def __init__(
        self, action="formatting", dxfId=None, pivotArea=None, extLst=None,
    ):
        self.action = action
        self.dxfId = dxfId
        self.pivotArea = pivotArea
...
class PageField(Serialisable):
    ...
    def __init__(
        self, fld=None, item=None, hier=None, name=None, cap=None, extLst=None,
    ):
        self.fld = fld
        self.item = item
        self.hier = hier
