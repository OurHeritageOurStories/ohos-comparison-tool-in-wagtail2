...
class ColorFilter(Serialisable):
    ...
    def __init__(
        self, dxfId=None, cellColor=None,
    ):
        self.dxfId = dxfId
...
class DynamicFilter(Serialisable):
    ...
    def __init__(
        self, type=None, val=None, valIso=None, maxVal=None, maxValIso=None,
    ):
        self.type = type
        self.val = val
        self.valIso = valIso
...
class Top10(Serialisable):
    ...
    def __init__(
        self, top=None, percent=None, val=None, filterVal=None,
    ):
        self.top = top
...
class Filters(Serialisable):
    ...
    def __init__(
        self, blank=None, calendarType=None, filter=(), dateGroupItem=(),
    ):
        self.blank = blank
...
class AutoFilter(Serialisable):
    ...
    def __init__(
        self, ref=None, filterColumn=(), sortState=None, extLst=None,
    ):
        self.ref = ref
