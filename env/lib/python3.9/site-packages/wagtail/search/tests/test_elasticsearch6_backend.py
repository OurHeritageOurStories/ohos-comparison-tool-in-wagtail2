...
class TestElasticsearch6SearchQuery(TestCase):
    ...
    def test_and_operator(self):
        ...
        expected_result = {
            "bool": {
                "filter": {"match": {"content_type": "searchtests.Book"}},
                "must": {
                    "match": {"_all_text": {"query": "Hello", "operator": "and",}}
                },
            }
        }
        self.assertDictEqual(query.get_query(), expected_result)
    ...
    def test_fuzzy_query(self):
        # Create a query
        query_compiler = self.query_compiler_class(
            models.Book.objects.all(), Fuzzy("Hello world"),
        )
    ...
    def test_fuzzy_query_single_field(self):
        # Create a query
        query_compiler = self.query_compiler_class(
            models.Book.objects.all(), Fuzzy("Hello world"), fields=["title"],
        )
    ...
    def test_fuzzy_query_multiple_fields_disallowed(self):
        # Create a query
        query_compiler = self.query_compiler_class(
            models.Book.objects.all(), Fuzzy("Hello world"), fields=["title", "body"],
        )
    ...
    def test_year_filter(self):
        # Create a query
        query_compiler = self.query_compiler_class(
            models.Book.objects.filter(publication_date__year=1900), "Hello"
        )
...
class TestElasticsearch6Mapping(TestCase):
        ...
        expected_result = {
            "doc": {
                "properties": {
                    ...
                    "title": {"type": "text", "boost": 2.0, "copy_to": "_all_text",},
                    "title_edgengrams": {
                        "type": "text",
                        "analyzer": "edgengram_analyzer",
                        "search_analyzer": "standard",
    ...
    def test_get_document(self):
        ...
        expected_result = {
            ...
            "_edgengrams": ["J. R. R. Tolkien", "The Fellowship of the Ring",],
