...
class TestElasticsearch5SearchQuery(TestCase):
    ...
    def test_and_operator(self):
        ...
        expected_result = {
            "bool": {
                "filter": {"match": {"content_type": "searchtests.Book"}},
                "must": {"match": {"_all": {"query": "Hello", "operator": "and",}}},
            }
        }
        self.assertDictEqual(query_compiler.get_query(), expected_result)
    ...
    def test_phrase_query(self):
        ...
        # Check it
        expected_result = {"match_phrase": {"_all": "Hello world",}}
...
class TestElasticsearch5Mapping(TestCase):
        ...
        expected_result = {
            "searchtests_book": {
                "properties": {
                    ...
                    "title": {"type": "text", "boost": 2.0, "include_in_all": True,},
                    "title_edgengrams": {
                        "type": "text",
                        "include_in_all": False,
                        "analyzer": "edgengram_analyzer",
    ...
    def test_get_document(self):
        ...
        expected_result = {
            ...
            "_partials": ["J. R. R. Tolkien", "The Fellowship of the Ring",],
