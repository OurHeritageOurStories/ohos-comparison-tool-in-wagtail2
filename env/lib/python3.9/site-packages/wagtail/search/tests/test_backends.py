...
class BackendTests(WagtailTestUtils):
    ...
    def test_autocomplete(self):
        ...
        self.assertUnsortedListEqual(
            [r.title for r in results], ["Learning Python",],
        )
    ...
    def test_autocomplete_uses_autocompletefield(self):
        ...
        self.assertUnsortedListEqual(
            [r.name for r in results], ["George R.R. Martin",],
        )
    ...
    def test_facet_tags(self):
        ...
        self.assertEqual(
            results, OrderedDict([(fantasy_tag.id, 7), (None, 6), (scifi_tag.id, 1),]),
        )
    ...
    def test_boost(self):
        ...
        self.assertEqual(
            [r.title for r in results],
            ["Learning Python", "JavaScript: The Definitive Guide",],
        )
        ...
        self.assertEqual(
            [r.title for r in results],
            ["JavaScript: The Definitive Guide", "Learning Python",],
        )
