...
class TestSearchFields(TestCase):
    ...
    def test_basic(self):
        cls = self.make_dummy_type(
            [index.SearchField("test", boost=100), index.FilterField("filter_test"),]
        )
    ...
    def test_overriding(self):
        ...
        # as intended.
        cls = self.make_dummy_type(
            [index.SearchField("test", boost=100), index.SearchField("test"),]
        )
    ...
    def test_different_field_types_dont_override(self):
        ...
        cls = self.make_dummy_type(
            [index.SearchField("test", boost=100), index.FilterField("test"),]
        )
    ...
    def test_checking_core_page_fields_are_indexed(self):
        ...
        for error in errors:
            self.assertEqual(
                error.msg, "Core Page fields missing in `search_fields`",
            )
            self.assertIn(
