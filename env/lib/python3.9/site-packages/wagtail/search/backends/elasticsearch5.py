...
class Elasticsearch5Mapping:
    ...
    def get_mapping(self):
        ...
        return {self.get_document_type(): {"properties": fields,}}
...
class Elasticsearch5SearchQueryCompiler(BaseSearchQueryCompiler):
    ...
    def _compile_fuzzy_query(self, query, fields):
        ...
        return {
            "match": {fields[0]: {"query": query.query_string, "fuzziness": "AUTO",}}
        }
...
class Elasticsearch5SearchResults(BaseSearchResults):
    ...
    def facet(self, field_name):
        ...
        body["aggregations"] = {
            field_name: {"terms": {"field": column_name, "missing": 0,}}
        }
    ...
    def _do_search(self):
        ...
        if use_scroll:
            ...
            params.update(
                {"from_": self.start, "size": limit or PAGE_SIZE,}
            )
...
class Elasticsearch5Index:
    ...
    def delete_item(self, item):
        ...
        try:
            self.es.delete(
                self.name, mapping.get_document_type(), mapping.get_document_id(item),
            )
        except NotFoundError:
