        ...
        self.assertEqual(
            ...
            [
                ...
                },
                {
                    ...
                    "_args": [
                        "Everything Is Love",
                        [{"_ref": 0}, {"_type": "music.Artist", "_args": ["Jay-Z"]},],
                    ],
                },
            ],
        )
    ...
    def test_list_references(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                {"_type": "music.Album", "_args": ["Survivor", {"_ref": 0},],},
            ],
        )
    ...
    def test_primitive_value_references(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                {"_type": "music.Album", "_args": [{"_ref": 0}, [{"_ref": 1},],],},
            ],
        )
            ...
            [
                {
                    ...
                    "_args": [
                        "Dangerously in Love",
                        [{"_type": "music.Artist", "_args": ["Beyoncé"], "_id": 1,},],
                    ],
                },
                {"_type": "music.Album", "_args": ["Beyoncé", [{"_ref": 1},],],},
            ],
        )
