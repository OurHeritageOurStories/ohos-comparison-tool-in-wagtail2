...
class TestPagePrivacy(WagtailTestUtils, TestCase):
    ...
    def test_anonymous_user_must_authenticate(self):
        ...
        response = self.client.post(
            submit_url, {"password": "wrongpassword", "return_url": "/secret-plans/",},
        )
        self.assertEqual(
            response.templates[0].name, "wagtailcore/password_required.html"
        )
        ...
        response = self.client.post(
            submit_url, {"password": "swordfish", "return_url": "/secret-plans/",},
        )
        ...
        with self.settings(LOGIN_REDIRECT_URL="/"):
            response = self.client.post(
                submit_url,
                {"password": "swordfish", "return_url": "https://invaliddomain.com",},
            )
    ...
    def test_view_restrictions_apply_to_subpages(self):
        ...
        response = self.client.post(
            submit_url,
            {"password": "swordfish", "return_url": "/secret-plans/steal-underpants/",},
        )
