...
class TestCopyPage(TestCase):
    ...
    def test_copy_page_with_unique_uuids_in_orderables(self):
        ...
        christmas_page.speakers.add(
            EventPageSpeaker(first_name="Santa", last_name="Claus",)
        )
        christmas_page.save()
...
class TestGetLock(TestCase):
    ...
    def test_when_locked_without_locked_at(self):
        ...
        lock = christmas_event.get_lock()
        self.assertEqual(
            lock.get_message(christmas_event.owner), "<b>'Christmas' is locked</b>.",
        )
        self.assertEqual(
            lock.get_message(moderator), "<b>'Christmas' is locked</b> by <b>you</b>.",
        )
