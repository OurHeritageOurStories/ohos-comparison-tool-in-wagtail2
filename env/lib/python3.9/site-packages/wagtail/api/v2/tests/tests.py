...
class TestParseFieldsParameter(TestCase):
    ...
    def test_valid_multiple_fields(self):
        ...
        self.assertEqual(
            parsed, [("test", False, None), ("another_test", False, None),],
        )
    ...
    def test_valid_star_field(self):
        ...
        self.assertEqual(
            parsed, [("*", False, None), ("test", True, None),],
        )
    ...
    def test_valid_underscore_field(self):
        ...
        self.assertEqual(
            parsed, [("_", False, None), ("test", False, None),],
        )
