...
class TestCreateView(BaseWorkflowsTestCase):
    ...
    def test_post_submit_for_moderation(self):
        ...
        self.assertEqual(
            object.current_workflow_state.status, WorkflowState.STATUS_IN_PROGRESS,
        )
        ...
        self.assertEqual(
            object.current_workflow_task_state.revision, object.latest_revision,
        )
...
class TestEditView(BaseWorkflowsTestCase):
    ...
    def test_post_submit_for_moderation(self):
        ...
        # The object should now be in moderation
        self.assertEqual(
            self.object.current_workflow_state.status, WorkflowState.STATUS_IN_PROGRESS,
        )
...
class TestConfirmWorkflowCancellation(BaseWorkflowsTestCase):
    ...
    def test_get_confirm_workflow_cancellation_with_disabled_setting(self):
        ...
        self.assertJSONEqual(
            response.content.decode(), {"step": "no_confirmation_needed"},
        )
