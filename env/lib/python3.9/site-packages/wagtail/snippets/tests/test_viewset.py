...
class TestCustomIcon(BaseSnippetViewSetTests):
    ...
    def test_get_workflow_history_detail(self):
        ...
        WorkflowContentType.objects.create(
            content_type=self.content_type, workflow=self.workflow,
        )
...
class TestAdminURLs(BaseSnippetViewSetTests):
    def test_default_url_namespace(self):
        ...
        self.assertEqual(
            viewset.get_admin_url_namespace(), "wagtailsnippets_tests_advert",
        )
        # Get specific URL name
        self.assertEqual(
            viewset.get_url_name("edit"), "wagtailsnippets_tests_advert:edit",
        )
        # Chooser namespace
        self.assertEqual(
    ...
    def test_default_admin_base_path(self):
        ...
        # Chooser base path
        self.assertEqual(
            viewset.get_chooser_admin_base_path(), "snippets/choose/tests/advert",
        )
    ...
    def test_custom_admin_base_path(self):
        ...
        # Chooser base path
        self.assertEqual(
            viewset.get_chooser_admin_base_path(), "choose/wisely",
        )
        # Get specific chooser URL
        self.assertEqual(
            reverse(viewset.chooser_viewset.get_url_name("choose")),
...
class TestListFilterWithList(BaseSnippetViewSetTests):
    ...
    def create_test_snippets(self):
        ...
        self.model.objects.create(
            text="A second one after that", first_published_at=self.date,
        )
...
class TestDjangoORMSearchBackend(BaseSnippetViewSetTests):
    ...
    def test_search_index_view(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertCountEqual(
            list(response.context["page_obj"].object_list), [self.first, self.second],
        )
    ...
    def test_search_index_results_view(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertCountEqual(
            list(response.context["object_list"]), [self.second, self.third],
        )
