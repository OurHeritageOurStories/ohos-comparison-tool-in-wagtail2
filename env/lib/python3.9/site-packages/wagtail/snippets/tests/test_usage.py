...
class TestSnippetUsageView(WagtailTestUtils, TestCase):
    ...
    def test_use_latest_draft_as_title(self):
        ...
        response = self.client.get(
            reverse(
                "wagtailsnippets_tests_draftstatemodel:usage", args=[quote(snippet.pk)],
            )
        )
    ...
    def test_usage(self):
        ...
        gfk_page = GenericSnippetPage(
            title="Foobar Title", snippet_content_object=Advert.objects.get(pk=1),
        )
    ...
    def test_usage_with_describe_on_delete_gfk(self):
        ...
        gfk_page = GenericSnippetPage(
            title="Foobar Title", snippet_content_object=advert,
        )
