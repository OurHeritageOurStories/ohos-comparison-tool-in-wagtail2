...
class TestFillOperation(ImageTransformOperationTestCase):
    ...
    run_tests = [
        ...
        ("fill-100x100", {"width": 1, "height": 1,}, [("crop", (0, 0, 1, 1)),],),
        # This one once gave a ZeroDivisionError
        ("fill-100x150", {"width": 1, "height": 1,}, [("crop", (0, 0, 1, 1)),],),
        ("fill-150x100", {"width": 1, "height": 1,}, [("crop", (0, 0, 1, 1)),],),
    ]
...
class TestMinMaxOperation(ImageTransformOperationTestCase):
    ...
    run_tests = [
        # Basic usage of min
        ("min-800x600", {"width": 1000, "height": 1000}, [("resize", (800, 800)),],),
        # Basic usage of max
        ("max-800x600", {"width": 1000, "height": 1000}, [("resize", (600, 600)),],),
        # Resize doesn't try to set zero height
        ("max-400x400", {"width": 1000, "height": 1}, [("resize", (400, 1)),],),
        # Resize doesn't try to set zero width
        ("max-400x400", {"width": 1, "height": 1000}, [("resize", (1, 400)),],),
    ]
...
class TestWidthHeightOperation(ImageTransformOperationTestCase):
    ...
    run_tests = [
        ...
        ("width-400", {"width": 1000, "height": 500}, [("resize", (400, 200)),],),
        # Basic usage of height
        ("height-400", {"width": 1000, "height": 500}, [("resize", (800, 400)),],),
        # Resize doesn't try to set zero height
        ("width-400", {"width": 1000, "height": 1}, [("resize", (400, 1)),],),
        # Resize doesn't try to set zero width
        ("height-400", {"width": 1, "height": 800}, [("resize", (1, 400)),],),
    ]
...
class TestScaleOperation(ImageTransformOperationTestCase):
    ...
    run_tests = [
        ...
        ("scale-100", {"width": 1000, "height": 500}, [("resize", (1000, 500)),],),
        # Basic usage of scale
        ("scale-50", {"width": 1000, "height": 500}, [("resize", (500, 250)),],),
        ...
        # Resize doesn't try to set zero height
        ("scale-50", {"width": 1000, "height": 1}, [("resize", (500, 1)),],),
        # Resize doesn't try to set zero width
        ("scale-50", {"width": 1, "height": 500}, [("resize", (1, 250)),],),
    ]
...
class TestWebpFormatConversion(TestCase):
    def test_webp_convert_to_png(self):
        ...
        fil = Filter(spec="width-400")
        image = Image.objects.create(
            title="Test image", file=get_test_image_file_webp(),
        )
        out = fil.run(image, BytesIO())
