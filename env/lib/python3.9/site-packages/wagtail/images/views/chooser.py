    ...
    def post(self, request):
        ...
        if self.form.is_valid():
            ...
            duplicates = find_image_duplicates(
                image=image, user=request.user, permission_policy=permission_policy,
            )
...
class ImageChooserViewSet(ChooserViewSet):
    ...
    def select_format_view(self):
        return self.select_format_view_class.as_view(
            model=self.model, preserve_url_parameters=self.preserve_url_parameters,
        )
...
viewset = ImageChooserViewSet(
    "wagtailimages_chooser", model=get_image_model(), url_prefix="images/chooser",
)
