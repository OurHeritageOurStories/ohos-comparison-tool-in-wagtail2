...
def make_types_test_form_page(**kwargs):
    ...
    FormField.objects.create(
        page=form_page, sort_order=3, label="Email", field_type="email", required=False,
    )
    FormField.objects.create(
        page=form_page,
        sort_order=4,
    ...
    FormField.objects.create(
        page=form_page, sort_order=5, label="URL", field_type="url", required=False,
    )
    FormField.objects.create(
        page=form_page,
        sort_order=6,
    ...
    FormField.objects.create(
        page=form_page, sort_order=11, label="Date", field_type="date", required=False,
    )
    FormField.objects.create(
        page=form_page,
        sort_order=12,
