...
class TestFormPageWithCustomFormBuilder(WagtailTestUtils, TestCase):
    ...
    def test_post_valid_form(self):
        response = self.client.post(
            "/support-request/",
            {"name": "Ron Johnson", "device_ip_address": "192.0.2.30",},
        )
...
class TestCleanedDataEmails(TestCase):
    ...
    def test_datetime_normalization(self):
        self.client.post(
            "/contact-us/", {"datetime": "12/31/17 4:00:00",},
        )
        ...
        self.client.post(
            "/contact-us/", {"datetime": "12/31/1917 21:19",},
        )
        ...
        self.client.post(
            "/contact-us/", {"datetime": "1910-12-21 21:19:12",},
        )
...
class TestFormFieldCleanNameCreation(WagtailTestUtils, TestCase):
    ...
    def test_form_field_clean_name_creation(self):
        ...
        field = FormFieldWithCustomSubmission.objects.create(
            page=self.form_page, label="Telefón-nummer", field_type="number",
        )
