    ...
    def test_move_translated_pages(self):
        ...
        response = self.client.post(
            reverse(
                ...
                args=(self.en_blog_post.id, self.en_homepage.id,),
            ),
            follow=True,
        )
        self.assertEqual(response.status_code, 200)
...
class TestDeletingTranslatedPages(Utils):
    ...
    def test_delete_translated_pages(self):
        ...
        response = self.client.post(
            reverse("wagtailadmin_pages:delete", args=(self.en_blog_post.id,),),
            follow=True,
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_deleting_page_with_divergent_translation_tree(self):
        ...
        action = MovePageAction(
            self.fr_blog_post, self.fr_new_parent, pos="last-child", user=None,
        )
