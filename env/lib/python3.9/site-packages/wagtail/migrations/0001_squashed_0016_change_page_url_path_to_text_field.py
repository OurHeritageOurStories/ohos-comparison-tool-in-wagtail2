...
def initial_data(apps, schema_editor):
    ...
    GroupPagePermission.objects.create(
        group=moderators_group, page=root, permission_type="lock",
    )
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name="pagerevision", options={"verbose_name": "Page Revision"},
        ),
        migrations.CreateModel(
        ...
        migrations.AlterModelOptions(name="site", options={"verbose_name": "Site"},),
