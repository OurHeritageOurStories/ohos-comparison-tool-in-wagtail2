...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            disable_sqlite_legacy_alter_table, migrations.RunPython.noop,
        ),
        migrations.RenameModel(old_name="PageRevision", new_name="Revision",),
        ...
        migrations.RenameField(
            model_name="revision", old_name="page", new_name="object_id",
        ),
        migrations.AddField(
            model_name="revision",
            name="content_type",
