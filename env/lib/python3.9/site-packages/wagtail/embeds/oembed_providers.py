...
coub = {
    ...
    "urls": [r"^https?://coub\.com/view/.+$", r"^https?://coub\.com/embed/.+$",],
}
...
dailymile = {
    ...
    "urls": [r"^https?://(?:www\.)?dailymile\.com/people/[^#?/]+/entries/.+$",],
}


dailymotion = {
    "endpoint": "https://www.dailymotion.com/api/oembed/",
    "urls": [r"^https?://[-\w]+\.dailymotion\.com/.+$",],
}

datastudio = {
    "endpoint": "https://datastudio.google.com/oembed",
    "urls": [r"^https?://(?:[-\w]+\.)?datastudio\.google\.com/embed/.+$",],
}
...
dipdive = {
    ...
    "urls": [r"^http://[-\w]+\.dipdive\.com/media/.+$",],
}
...
funny_or_die = {
    ...
    "urls": [r"^https?://www\.funnyordie\.com/videos/.+$",],
}
...
qik = {
    ...
    "urls": [r"^http://qik\.com/.+$", r"^http://qik\.ly/.+$",],
}
...
skitch = {
    ...
    "urls": [r"^https?://(?:www\.)?skitch\.com/.+$", r"^http://skit\.ch/.+$",],
}

slideshare = {
    "endpoint": "https://www.slideshare.net/api/oembed/2",
    "urls": [r"^https?://www\.slideshare\.net/.+$",],
}


smugmug = {
    "endpoint": "https://api.smugmug.com/services/oembed/",
    "urls": [r"^https?://(?:www\.)?smugmug\.com/[^#?/]+/.+$",],
}


soundcloud = {
    "endpoint": "https://soundcloud.com/oembed",
    "urls": [r"^https://soundcloud\.com/.+$",],
}


speakerdeck = {
    "endpoint": "https://speakerdeck.com/oembed.{format}",
    "urls": [r"^https?://speakerdeck\.com/.+$",],
}


spotify = {
    "endpoint": "https://embed.spotify.com/oembed/",
    "urls": [r"^https?://open\.spotify\.com/.+$", r"^https?://spoti\.fi/.+$",],
}
