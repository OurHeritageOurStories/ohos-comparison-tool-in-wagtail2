...
class RevisionMixin(models.Model):
    ...
    def revisions(self):
        ...
        return Revision.objects.filter(
            content_type=self.get_content_type(), object_id=self.pk,
        )
    ...
    def get_default_workflow(cls):
        ...
        workflow_content_type = (
            WorkflowContentType.objects.filter(
                workflow__active=True, content_type=content_type,
            )
...
class Page(AbstractPage, index.Indexed, ClusterableModel, metaclass=PageBase):
    ...
    def update_aliases(
        ...
        for alias in self.specific_class.objects.filter(alias_of=self).exclude(
            ...
            log(
                instance=alias_updated, action="wagtail.publish", user=user,
            )
            ...
            alias.update_aliases(
                revision=revision, _content=_content, _updated_ids=_updated_ids,
            )
...
class Revision(models.Model):
    ...
    def get_previous(self):
        return self.get_previous_by_created_at(
            base_content_type_id=self.base_content_type_id, object_id=self.object_id,
        )
    ...
    def all_tasks_with_status(self):
        ...
        tasks = list(
            self.workflow.tasks.annotate(
                status=Subquery(
                    task_states.filter(task_id=OuterRef("id"),)
        ...
        log(
            ...
            data={
                "workflow": {
                    ...
                    "task": {"id": self.task.id, "title": self.task.name,},
                    "next": next_task_data,
                },
    ...
    def _log(self, action, page_revision=None, user=None):
        log(
            ...
            data={
                ...
                "reply": {"id": self.pk, "text": self.text,},
            },
        )
