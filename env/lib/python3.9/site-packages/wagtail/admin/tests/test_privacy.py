...
class TestSetPrivacyView(WagtailTestUtils, TestCase):
    def setUp(self):
        ...
        self.public_page = self.homepage.add_child(
            instance=SimplePage(title="Public page", content="hello", live=True,)
        )
        ...
        self.private_child_page = self.private_page.add_child(
            instance=SimplePage(title="Private child page", content="hello", live=True,)
        )

        self.private_groups_page = self.homepage.add_child(
            instance=SimplePage(
                title="Private groups page", content="hello", live=True,
            )
        )
        ...
        self.private_groups_child_page = self.private_groups_page.add_child(
            instance=SimplePage(
                title="Private groups child page", content="hello", live=True,
            )
        )
...
class TestPrivacyIndicators(WagtailTestUtils, TestCase):
    ...
    def test_explorer_list_homepage(self):
        ...
        self.assertContains(
            response, 'class="indicator privacy-indicator"', count=1,
        )
