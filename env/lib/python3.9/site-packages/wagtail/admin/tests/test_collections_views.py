...
class TestAddCollectionAsSuperuser(WagtailTestUtils, TestCase):
    ...
    def test_post(self):
        response = self.post(
            {"name": "Holiday snaps", "parent": self.root_collection.id,}
        )
...
class TestAddCollection(CollectionInstanceTestUtils, WagtailTestUtils, TestCase):
    ...
    def test_marketing_user_with_add_permission(self):
        ...
        response = self.post(
            {"name": "Affiliate Marketing", "parent": self.marketing_collection.id,}
        )
    ...
    def test_marketing_user_cannot_add_outside_their_hierarchy(self):
        ...
        response = self.post(
            {"name": "Affiliate Marketing", "parent": self.root_collection.id,}
        )
        self.assertEqual(
