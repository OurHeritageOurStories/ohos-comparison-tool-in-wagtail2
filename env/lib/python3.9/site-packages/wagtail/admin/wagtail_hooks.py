...
def register_settings_menu():
    return SettingsMenuItem(
        _("Settings"), settings_menu, name="settings", icon_name="cogs", order=10000,
    )
...
def register_core_features(features):
    ...
    features.register_editor_plugin(
        ...
        draftail_features.InlineStyleFeature(
            {"type": "BOLD", "icon": "bold", "description": gettext("Bold"),}
        ),
    )
    features.register_converter_rule(
        "contentstate",
    ...
    features.register_editor_plugin(
        ...
        "italic",
        draftail_features.InlineStyleFeature(
            {"type": "ITALIC", "icon": "italic", "description": gettext("Italic"),}
        ),
    )
    features.register_converter_rule(
        "contentstate",
    ...
    features.register_editor_plugin(
        ...
        "code",
        draftail_features.InlineStyleFeature(
            {"type": "CODE", "icon": "code", "description": gettext("Code"),}
        ),
    )
    features.register_converter_rule(
        "contentstate",
...
def register_help_menu():
    return DismissibleSubmenuMenuItem(
        _("Help"), help_menu, name="help", icon_name="help", order=11000,
    )
