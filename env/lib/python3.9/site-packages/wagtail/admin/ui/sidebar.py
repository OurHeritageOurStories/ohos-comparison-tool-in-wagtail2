...
class BaseSidebarAdapter(Adapter):
    @cached_property
    def media(self):
        return forms.Media(js=[versioned_static("wagtailadmin/js/sidebar.js"),])
...
class LinkMenuItem(MenuItem):
    def __init__(
        ...
        super().__init__(
            name, label, icon_name=icon_name, classnames=classnames, attrs=attrs,
        )
        self.url = url
...
class PageExplorerMenuItem(LinkMenuItem):
    def __init__(
        ...
        super().__init__(
            name, label, url, icon_name=icon_name, classnames=classnames, attrs=attrs,
        )
