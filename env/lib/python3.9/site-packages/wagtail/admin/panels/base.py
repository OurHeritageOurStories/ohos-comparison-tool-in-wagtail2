...
def get_form_for_model(
    model, form_class=WagtailAdminModelForm, **kwargs,
):
    """
...
class Panel:
    ...
    def __init__(
        self, heading="", classname="", help_text="", base_form_class=None, icon="",
    ):
    ...
    def get_form_class(self):
        ...
        return get_form_for_model(
            self.model, form_class=base_form_class, **form_options,
        )
    ...
    def __repr__(self):
        return "<%s with model=%s>" % (self.__class__.__name__, self.model,)
