...
class BaseChooser(widgets.Input):
    ...
    def render_html(self, name, value_data, attrs):
        return render_to_string(
            self.template_name, self.get_context(name, value_data or {}, attrs),
        )
    ...
    @cached_property
    def media(self):
        return forms.Media(js=[versioned_static("wagtailadmin/js/chooser-widget.js"),])
...
class BaseChooserAdapter(WidgetAdapter):
    ...
    def media(self):
        return forms.Media(
            js=[versioned_static("wagtailadmin/js/chooser-widget-telepath.js"),]
        )
