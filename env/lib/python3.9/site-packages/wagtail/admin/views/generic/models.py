...
class IndexView(
    ...
    def get_filterset_class(self):
        ...
        return type(
            f"{self.model.__name__}FilterSet", (WagtailFilterSet,), {"Meta": Meta},
        )
    ...
    def _get_custom_column(self, field_name, column_class=Column, **kwargs):
        ...
        return column_class(
            field_name, label=label.title(), sort_key=sort_key, **kwargs,
        )
    ...
    def get_table(self, object_list, **kwargs):
        return self.table_class(
            self.columns, object_list, ordering=self.get_ordering(), **kwargs,
        )
...
class CreateView(
    ...
    def save_action(self):
        ...
        if success_message is not None:
            messages.success(
                self.request, success_message, buttons=success_buttons,
            )
...
class RevisionsUnscheduleView(WagtailAdminTemplateMixin, TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if success_message:
            messages.success(
                request, success_message, buttons=success_buttons,
            )
